      ...
      <ul class="flex justify-between space-x-5 lg:space-x-8 items-center p-4">
        <div class="flex space-x-5 lg:space-x-8 items-center p-4">
          <li class="text_netflix text-3xl text-red-600">NetfliCS</li>
            ...
            <router-link
              to="/"
              class="font-bold text-sm lg:text-base text-white hover:text-app-green-1 transition ease-in-out duration-300">Home</router-link>
              ...
              v-if="$root.authenticated"
                to="/mylist"
                class="font-bold text-sm text-left lg:text-base text-white hover:text-app-green-1 transition ease-in-out duration-300">My WatchList</router-link>
        </div>
            ...
            <router-link
              ...
              <router-link
               @click="logout()"
                to="/"
                v-else
                class="flex-1 font-bold text-sm text-right lg:text-base text-white hover:text-app-green-1 transition ease-in-out duration-300">Logout</router-link>
              <router-link
                to="/add"
                class="font-bold text-sm text-left lg:text-base text-white hover:text-app-green-1 transition ease-in-out duration-300">Add Movie</router-link>
</div>
      </ul>
