<template>
      <div class="movies-list" :style="`background-image: linear-gradient(rgba(0,0,0,.7), rgba(0,0,0,.7)), url('https://mrserie.fr/wp-content/uploads/2021/11/Netflix-Background-1-1024x576.jpg?ezimgfmt=ng:webp/ngcb1')`">
